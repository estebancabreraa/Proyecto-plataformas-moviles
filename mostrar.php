	...
	<body>
		<?php
			...
			if ($integrante == "Esteban Cabrera Arevalo"){
				...
				echo "<h3>Lugar de nacimiento: Guatemala, Guatemala,</h3>";
				echo "<h3>Domicilio: 16 CALLE 38-18 ZONA 5 JARDINES DE LA ASUNCION SUR.</h3>";
				echo "<h3>Telefono: 5017-1741.</h3>";
				echo "<h3>Correo: mon17014@uvg.edu.gt.</h3>";
				echo "<h3>Lenguajes: Ingl&eacutes, espanol, aleman, C/C++, Pascal, Perl C#, Java, Python. </h3>";
				echo "</center>";
			}			
		?>
	</body>
